...
/// Extract all structured data from the page (auto-detect).
/// Returns JSON with available sections: json_ld, microdata, tables, products,
/// articles, search_results, pricing, navigation, metadata.

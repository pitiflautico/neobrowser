...
pub async fn render_page(
    ...
    let cookie_headers = ghost_browser.cookies.all_headers();
    let (mut runtime, store) = v8_runtime::create_runtime_with_html(&html, &final_url, &cookie_headers, local_storage)?;

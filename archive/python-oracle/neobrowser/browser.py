...
from neobrowser.session import Session, AttachedSession
from neobrowser.tab_pool import TabPool
from neobrowser.page_analyzer import PageAnalyzer
from neobrowser.playbook import ActionRecorder, PlaybookStore, PlaybookRunner, Step
...
class Browser:
    ...
    def __init__(
        ...
        self._session = Session(profile, visible=visible)

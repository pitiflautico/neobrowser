...
import neobrowser.lifecycle as lifecycle_mod
from neobrowser.lifecycle import CompactionReport, DataLifecycleManager
...
def base(tmp_path, monkeypatch):
    ...
    import neobrowser.session as session_mod
    import neobrowser.chrome_process as cp_mod

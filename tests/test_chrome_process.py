...
# Module under test
# ---------------------------------------------------------------------------
from neobrowser.chrome_process import (
    ChromeProcess,
    find_free_port,
    open_new_tab,
    wait_for_chrome,
)
import neobrowser.chrome_process as _cp_module
...
class TestChromeProcessLaunch:
    ...
    def test_launch_uses_correct_flags(self, tmp_path: Path):
        ...
        with patch('neobrowser.chrome_process.find_free_port', return_value=19222), \

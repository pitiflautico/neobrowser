...
| 2026-08-20 | @t3dotgg | X/Bluesky reply | real vs headless browser for AI agents | borrador listo | pendiente envío del usuario; draft en `outreach-t3dotgg-2026-08-20.md` |

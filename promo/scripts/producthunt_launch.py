...
WEBSITE = os.environ.get("NEOBROWSER_PH_WEBSITE", "https://neobrowser.is-a-good.dev/")
...
Current bet: 95/10,000 GitHub stars, documented publicly at {WEBSITE.rstrip('/').split('://')[-1]}.

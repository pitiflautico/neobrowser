...
TITLE = "Show HN: MCP server that drives real Chrome with your logged-in sessions"
    ...
    async with stdio_client(server_params) as (read, write):
        async with ClientSession(read, write) as session:
            ...
            r = await call(session, "js", {"code": """
                ...
                url.focus();
                url.value = 'https://pitiflautico.github.io/neobrowser/';
            ...
            if "NeoBrowser" in text and "pitiflautico.github.io" in text:
                print("\n=== SHOW HN SUBMITTED ===")
            elif "item?id=49345320" in text or "flagged" in text.lower():
                print("\n=== REDIRECTED TO OLD THREAD ===")
